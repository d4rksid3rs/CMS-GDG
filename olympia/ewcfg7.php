...
define("EW_PROJECT_NAME", "olympia", TRUE); // Project name
define("EW_RANDOM_KEY", 'p9fA7Y9R3LvQ47Tv', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "olympia.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_USER", "poker", TRUE);
define("EW_CONN_PASS", "poker!@#", TRUE);
define("EW_CONN_DB", "poker", TRUE);
...
// Security
define("EW_ADMIN_USER_NAME", "bemon", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "system!@#", TRUE); // Administrator password
