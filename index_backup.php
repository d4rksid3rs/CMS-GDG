...
<html>
    ...
    <body>
        <div class="pagewrap">
			...
			<div class="box grid">
                <div class="box_header">
                    <a href="javascript:void(0);">Sâm - <?php echo $sam["online"]; ?> user online - <?php echo $sam["playingTable"]; ?> playing table</a>
                </div>
                <div class="box_body" style="display:none;">
                    <?php
                    foreach ($samKey as $key) {
                        ...
                        foreach ($sam[$key] as $room) {
                            echo "<div class=\"room_box\">";
                            echo "<div class=\"room_box_title room_dark\"><a href=\"room.php?name=Sam - " . $key . " - " . $room["name"] . "&id=" . $room["id"] . "\">" . $room["name"] . "</a></div>";
                            if ($room["online"] <= $room["limit"] / 2) {
                                echo "<div class=\"room_box_body room_green\"><a href=\"room.php?name=Sam - " . $key . " - " . $room["name"] . "&id=" . $room["id"] . "\">" . $room["online"] . "/" . $room["limit"] . "</a></div>";
                            } else if ($room["online"] <= $room["limit"] / 4 * 3) {
                                echo "<div class=\"room_box_body room_yellow\"><a href=\"room.php?name=Sam - " . $key . " - " . $room["name"] . "&id=" . $room["id"] . "\">" . $room["online"] . "/" . $room["limit"] . "</a></div>";
                            } else {
                                echo "<div class=\"room_box_body room_red\"><a href=\"room.php?name=Sam - " . $key . " - " . $room["name"] . "&id=" . $room["id"] . "\">" . $room["online"] . "/" . $room["limit"] . "</a></div>";
                            }
                            echo "</div>";
                        }
                    }
			...
			<div class="box grid">
                <div class="box_header">
                    <a href="javascript:void(0);">Tiến lên đếm lá - <?php echo $tienlenmndc["online"]; ?> user online - <?php echo $tienlenmndc["playingTable"]; ?> playing table</a>
                </div>
                <div class="box_body" style="display:none;">
                    <?php
                    foreach ($tienlenmndcKey as $key) {
                        ...
                        foreach ($tienlenmndc[$key] as $room) {
                            echo "<div class=\"room_box\">";
                            echo "<div class=\"room_box_title room_dark\"><a href=\"room.php?name=Tiến lên đếm lá - " . $key . " - " . $room["name"] . "&id=" . $room["id"] . "\">" . $room["name"] . "</a></div>";
                            if ($room["online"] <= $room["limit"] / 2) {
                                echo "<div class=\"room_box_body room_green\"><a href=\"room.php?name=Tiến lên đếm lá - " . $key . " - " . $room["name"] . "&id=" . $room["id"] . "\">" . $room["online"] . "/" . $room["limit"] . "</a></div>";
                            } else if ($room["online"] <= $room["limit"] / 4 * 3) {
                                echo "<div class=\"room_box_body room_yellow\"><a href=\"room.php?name=Tiến lên đếm lá - " . $key . " - " . $room["name"] . "&id=" . $room["id"] . "\">" . $room["online"] . "/" . $room["limit"] . "</a></div>";
                            } else {
                                echo "<div class=\"room_box_body room_red\"><a href=\"room.php?name=Tiến lên đếm lá - " . $key . " - " . $room["name"] . "&id=" . $room["id"] . "\">" . $room["online"] . "/" . $room["limit"] . "</a></div>";
                            }
                            echo "</div>";
                        }
                    }
