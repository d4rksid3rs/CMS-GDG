...
try {
    ...
    $html .= "<tr style='background-color: rgb(255, 255, 255)'><td>1</td><td>Tiến lên MN</td><td>" . number_format($tlmn) . "</td></td></tr>";
    $html .= "<tr style='background-color: rgb(255, 255, 255)'><td>2</td><td>Ba cây Chương</td><td>" . number_format($bacaych) . "</td></td></tr>";
    $html .= "<tr style='background-color: rgb(255, 255, 255)'><td>3</td><td>Tiến lên MN DC</td><td>" . number_format($tlmndc) . "</td></td></tr>";
    $html .= "<tr style='background-color: rgb(255, 255, 255)'><td>4</td><td>Xóc Đĩa</td><td>" . number_format($xoc_dia) . "</td></td></tr>";
    $html .= "<tr style='background-color: rgb(255, 255, 255)'><td>5</td><td>Phỏm</td><td>" . number_format($phom) . "</td></td></tr>";
    $html .= "<tr style='background-color: rgb(255, 255, 255)'><td>6</td><td>Liêng</td><td>" . number_format($lieng) . "</td></td></tr>";
    $html .= "<tr style='background-color: rgb(255, 255, 255)'><td>7</td><td>Sam</td><td>" . number_format($sam) . "</td></td></tr>";
    $html .= "<tr style='background-color: rgb(255, 255, 255)'><td>8</td><td>Bầu Cua</td><td>" . number_format($bau_cua) . "</td></td></tr>";
    $html .= "<tr style='background-color: rgb(255, 255, 255)'><td>9</td><td>Xi to</td><td>" . number_format($xi_to) . "</td></td></tr>";
    $html .= "<tr style='background-color: rgb(255, 255, 255)'><td>10</td><td>Poker</td><td>" . number_format($poker) . "</td></td></tr>";
    $html .= "<tr style='background-color: rgb(255, 255, 255)'><td>11</td><td>Ba Cây</td><td>" . number_format($ba_cay) . "</td></td></tr>";
    $html .= "<tr style='background-color: rgb(255, 255, 255)'><td>12</td><td>Tiền Bầu Cua ăn</td><td>" . number_format($host_bau_cua) . "</td></td></tr>";
    $html .= "<tr style='background-color: rgb(255, 255, 255)'><td>13</td><td>Tiền Xóc đĩa ăn</td><td>" . number_format($host_xoc_dia) . "</td></td></tr>";
    $html .= "<tr style='background-color: rgb(255, 255, 255)'><td>14</td><td>Tổng <span style='font-weight:bold;color:red;'>(A)</span></td><td>" . number_format($total_fee_game) . "</td></td></tr>";
    $html .= "</table>";
    ...
    $html .= "<tr style='background-color: rgb(255, 255, 255)'><td>4</td><td>Tổng DT Chia sẻ <span style='font-weight:bold;color:red;'>[(A + C) x0.81 + B x 0.45 + D x 0.65]</span></td><td>" . number_format($rev_share) . "</td></td></tr>";
    $html .= "</table>";
    echo $html;
    exit();
} catch (Exception $e) {
