...
$sql1 = "select count(*) as dau, client_version as name1, date(last_login) as date_login from user "
        . "where date(last_login) >= '{$start_date}' AND date(last_login) <= '{$end_date}' group by client_version, date(last_login)";
