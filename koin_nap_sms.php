<?php
	...
	try {
		$sql = "select sum(koin_added) as koin, date(created_on) as day from auth_user_partner where service='NAP' and date(created_on) >= '".$fromDate."' and date(created_on) <= '".$toDate."' group by day order by created_on";
		//die($sql);
    ...
    <script type="text/javascript">
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Ngày', 'Lượng Koin Nạp vào từ SMS'],
		  <?php
        ...
        new google.visualization.BarChart(document.getElementById('chart_div')).
            draw(data,
                 {title:"Lượng Koin Nạp vào từ SMS",
                  vAxis: {title: "Ngày"},
                  hAxis: {title: "Koins"},
